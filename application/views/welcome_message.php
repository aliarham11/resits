...
<script type="text/javascript" src="<?php echo base_url('/assets/js/highcharts/jquery-1.7.2.min.js'); ?>"></script>
...
<script type="text/javascript" src="<?php echo base_url('/assets/js/highcharts/themes/dark-green.js'); ?>"></script>
